    ...
    def run(self):
        ...
        for p in self.__parcel:
            ...
            for v in [2,5,10]:
                ...
                outdoor_water_savings = -25.57448901 + 0.30758578 * annual_outdoor_demand + 0.04312597*roof_area + 0.02942312*rainfall + 1.07407958*v
                non_potable_savings = -24.67593153 + 0.36694590 * annual_non_potable_demand + 0.05429158*roof_area + 0.03871018*rainfall + 1.08573363*v

                option.SetField("volume", v)
                option.SetField("outdoor_water_savings", max(0,min(outdoor_water_savings,annual_outdoor_demand)))
                option.SetField("non_potable_savings",  max(0, min(non_potable_savings,annual_non_potable_demand)))
